        ...
        <div className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="rounded-xl border border-white/10 p-4">
              <div className="text-white/70 text-sm">{t("account:dashboard.lastOrders", "Últimos pedidos")}</div>
              {lastOrders.length === 0 ? (
                <div className="mt-2 text-white/60 text-sm">{t("account:dashboard.noOrders", "Você ainda não tem pedidos.")}</div>
              ) : (
              ...
              <Link href="/conta/pedidos" className="inline-block mt-3 text-white underline underline-offset-4">
                {t("account:dashboard.viewAll", "Ver todos")}
              </Link>
            </div>

            <div className="rounded-xl border border-white/10 p-4">
              <div className="text-white/70 text-sm">{t("account:dashboard.quick", "Acessos rápidos")}</div>
              <div className="mt-2 flex flex-wrap gap-2">
                <Link href="/conta/enderecos" className="px-3 py-2 rounded-lg border border-white/15 text-white/80 hover:text-white hover:bg-white/5">
                  {t("account:nav.addresses", "Endereços")}
                </Link>
                <Link href="/favoritos" className="px-3 py-2 rounded-lg border border-white/15 text-white/80 hover:text-white hover:bg-white/5">
